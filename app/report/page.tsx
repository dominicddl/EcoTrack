...
export default function ReportPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (verificationStatus !== 'success' || !user) {
            toast.error('Please verify the waste type and amount before submitting or log in first');
            return;
        }
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="mt-2 text-sm text-green-700">
                                    ...
                                    <p>Confidence: {verificationResult.confidence > 1 ? verificationResult.confidence.toFixed(2) : (verificationResult.confidence * 100).toFixed(2)}%</p>
                                </div>
                            </div>
                        </div>
                    </div>
